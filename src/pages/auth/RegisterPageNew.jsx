        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          {step === 1 && (
            <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-primary-blue outline-none"
                      required
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-primary-blue outline-none"
                      required
                    />
                    <button
                      type="button"
              ...
              <button
                onClick={handleNext}
                className="w-full bg-primary-blue hover:bg-blue-600 text-white font-bold py-3 rounded-lg mt-6 transition-all"
              >
                Devam Et
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex gap-3 mt-6">
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="flex-1 border border-gray-300 hover:bg-gray-50 text-gray-700 font-bold py-3 rounded-lg transition-all"
                >
                  Geri
                </button>
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 bg-primary-blue hover:bg-blue-600 text-white font-bold py-3 rounded-lg disabled:opacity-50 transition-all"
                >
